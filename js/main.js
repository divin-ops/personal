...
function sendMail(){
    ...
    let parms = {
        ...
        message: document.getElementById("message").value  // Ensure you are getting message from the correct field
    };

    // Send email via EmailJS
    emailjs.send("service_b7s245t", "template_2t5qcwf", parms)
